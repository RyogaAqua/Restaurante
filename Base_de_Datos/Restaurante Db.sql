...
CREATE TABLE IF NOT EXISTS `mydb`.`Menu_Objetos` (
  `UPC Objeto` INT NOT NULL,
  `Nombre_Objeto` VARCHAR(45) NOT NULL,
  `Precio` INT NULL,
  `Categoria` VARCHAR(45) NOT NULL,
  `Calorias` INT NULL,
  PRIMARY KEY (`UPC Objeto`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Restaurante` (
  ...
  `UPC Objeto` INT NOT NULL,
  PRIMARY KEY (`Id_Restaurante`, `UPC Objeto`),
  INDEX `fk_Restaurante_Menu_Objetos1_idx` (`UPC Objeto` ASC) VISIBLE,
  CONSTRAINT `fk_Restaurante_Menu_Objetos1`
    FOREIGN KEY (`UPC Objeto`)
    REFERENCES `mydb`.`Menu_Objetos` (`UPC Objeto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Orden` (
  ...
  `Puntos` INT NOT NULL,
  `Address` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`Id_Transaccion`, `Restaurante`, `Id_Usuario`, `Puntos`, `Address`),
